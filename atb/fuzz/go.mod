...
require (
	...
	github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go v0.0.0
)
...
replace github.com/hyperledger/fabric-samples/asset-transfer-basic/chaincode-go => ../
